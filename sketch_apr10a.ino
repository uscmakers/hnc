...
void setup() {
  ...
  phasedel = analogRead(A2);
  state = phasedel/(pMax/3);
  Serial.println("Initial potentiometer reading");
...
void frequency (float testFrequency) {
  // readjustment of frequency
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    int tempState = analogRead(A2)/(pMax/3); 
    ...
    */
    ...
    if (microsecs > 1) {   //IMPORTANT - what sampling rate is needed/possible? order of microseconds?
